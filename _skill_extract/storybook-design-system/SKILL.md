...
## Storybook URL
```
https://am-storybook.azurewebsites.net/
```
...
```
GET https://am-storybook.azurewebsites.net/index.json
```

If that 404s, try:
```
GET https://am-storybook.azurewebsites.net/stories.json
```
...
```
GET https://am-storybook.azurewebsites.net/stories.json  (look up storyId)
```

Or navigate to the component's iframe URL:
```
https://am-storybook.azurewebsites.net/iframe.html?id=<story-id>&viewMode=docs
```
...
Example: `forms-button--primary`, `layout-stack--default`
...
- The Storybook is at `https://am-storybook.azurewebsites.net/` — always fetch live,
